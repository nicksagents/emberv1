...
| coordinator | project_overview, git_inspect, stat_path, list_directory, search_files, read_file, write_file, edit_file, run_terminal_command, web_search, http_request, fetch_page, credential_save, credential_list, credential_get, save_memory, memory_search, memory_get, session_recall, forget_memory, app_memory_save, app_memory_search, app_memory_get, app_memory_delete, app_memory_list, launch_parallel_tasks, system_info, process_manager, network_tools, ssh_execute, handoff + MCP |
| advisor     | project_overview, git_inspect, stat_path, list_directory, search_files, read_file, run_terminal_command, web_search, http_request, fetch_page, credential_save, credential_list, credential_get, save_memory, memory_search, memory_get, session_recall, forget_memory, app_memory_save, app_memory_search, app_memory_get, app_memory_delete, app_memory_list, launch_parallel_tasks, system_info, network_tools, ssh_execute, handoff + MCP |
| director    | project_overview, git_inspect, stat_path, list_directory, search_files, read_file, write_file, edit_file, run_terminal_command, web_search, http_request, fetch_page, credential_save, credential_list, credential_get, save_memory, memory_search, memory_get, session_recall, forget_memory, app_memory_save, app_memory_search, app_memory_get, app_memory_delete, app_memory_list, launch_parallel_tasks, system_info, process_manager, network_tools, ssh_execute, handoff + MCP |
| inspector   | project_overview, git_inspect, stat_path, list_directory, search_files, read_file, run_terminal_command, web_search, http_request, fetch_page, credential_save, credential_list, credential_get, save_memory, memory_search, memory_get, session_recall, forget_memory, app_memory_search, app_memory_get, app_memory_list, launch_parallel_tasks, system_info, process_manager, network_tools, ssh_execute, handoff + MCP |
